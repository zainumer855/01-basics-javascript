...
*/
const populations2 = [245.2, 8, 6, 1441];
...
for (let i = 0; i < populations2.length; i++) {
    percentages2.push(percentageOfWorld4(populations2[i]))
...
// console.log('-------------')
// const arrLength = listOfNeighbours.length;
...
while (i < populations2.length) {
    whileArr.push(percentageOfWorld4(populations2[i]));
    i++;
}
